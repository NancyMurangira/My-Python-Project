...
while genre <"1" or genre >"5":
    ...
    break
if genre =="1" :  
    print("Books available in True Crime:")
    ...
    print("Books available in Women Fiction:")
    ...
    print("Books available in Romantic:")
    ...
    print("Books available in Self Help Books:")
    ...
    print("Books available in Fairy Tale:")
...
choice = input("Would you like to select another genre?(yes/no)")
while choice == "no":
    print("")
